...
In terms of complexity, for <img src="http://latex.codecogs.com/svg.latex?\inline&space;n" title="n" /> disks, we have to make <img src="http://latex.codecogs.com/svg.latex?\inline&space;2^{n}&space;-&space;1" title="2^{n} - 1" /> movements. So, if we have 4 disks, we have to make 15 movements to achieve the required formation.<br />
{% capture fig_img %}
