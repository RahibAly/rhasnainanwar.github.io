...
In terms of complexity, for <span>$n$</span> disks, we have to make <span>$2^{n} - 1$</span> movements. So, if we have 4 disks, we have to make 15 movements to achieve the required formation.<br />
{% capture fig_img %}
