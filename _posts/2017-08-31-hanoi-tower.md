...
In terms of complexity, for ![n](http://latex.codecogs.com/svg.latex?\inline&space;n) disks, we have to make ![2^n - 1](http://latex.codecogs.com/svg.latex?\inline&space;2^{n}&space;-&space;1) movements. So, if we have 4 disks, we have to make 15 movements to achieve the required formation.<br />
{% capture fig_img %}
